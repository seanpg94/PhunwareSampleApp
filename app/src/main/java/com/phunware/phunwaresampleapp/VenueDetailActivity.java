 ...
 * in a {@link VenueListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link com.phunware.phunwaresampleapp.fragments.VenueDetailFragment}.
 */
public class VenueDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mVenue = getIntent().getParcelableExtra(VenueDetailFragment.ARG_VENUE);

            arguments.putParcelable(VenueDetailFragment.ARG_VENUE, mVenue);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ShareHelper.updateShareActionProvider(mShareActionProvider, this, mVenue);
